...
def gera_texto(mensagens):
    ...
    if tool_calls := resposta.choices[0].message.tool_calls:
        ...
        segunda_resposta = client.chat.completions.create(
            messages=mensagens, model="gpt-3.5-turbo"
        )
...
if user_input := st.chat_input("Digite sua pergunta sobre cotações de ações..."):
